		...
		btnOK.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {				
				...
				if (!btn1Label.getText().equals("0")) {						
					win.jpanel05.setTextBox("붉은대게와퍼세트  \t" + btn1Label.getText() +"개  \t"+icounnt1*setMenu1Price+ "원 \n");
				}
				if (!btn2Label.getText().equals("0")) {					
					win.jpanel05.setTextBox("더콰트로치즈세트  \t" + btn2Label.getText() + "개  \t"+icounnt2*setMenu2Price+ "원 \n");
				}
				if (!btn3Label.getText().equals("0")) {					
					win.jpanel05.setTextBox("트러플통모짜와퍼세트  \t" + btn3Label.getText() +"개  \t"+icounnt3*setMenu3Price+ "원 \n");
				}
				if (!btn4Label.getText().equals("0")) {					
					win.jpanel05.setTextBox("통모짜와퍼세트  \t" + btn4Label.getText() + "개  \t"+icounnt4*setMenu4Price+ "원 \n");
				}
