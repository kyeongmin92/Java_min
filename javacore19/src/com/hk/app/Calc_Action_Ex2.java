...
public class Calc_Action_Ex2 extends JFrame {
    private String chkInput; // 현재 연산을 구분할 체크 값 변수 (덧셈인지, 뺄셈인지 구분 하기 위한 변수)
    private int numOne, sum, total; // 대입연산에 필요한 변수 (numOne, sum, total)
 ...
 {
  Calc_Action_Ex2 calStart = new Calc_Action_Ex2(); // 객체 생성
